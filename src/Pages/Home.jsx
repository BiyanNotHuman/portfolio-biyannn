...
const WORDS = ["GIS Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js", "CSS"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/BiyanNotHuman" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/biyannn/" },
  { icon: Instagram, link: "https://www.instagram.com/biyannothuman_/?hl=id" }
];
