...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/biyannn/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@biyannothuman_",
    icon: Instagram,
    url: "https://www.instagram.com/biyannothuman_/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Muhammad Fathin Ainul Abyan",
    icon: Youtube,
    url: "",
    color: "#FF0000",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@biyannnnnn_",
    color: "black",
